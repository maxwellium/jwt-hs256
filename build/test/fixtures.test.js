const RESET = '\x1b[0m';
export const _red = (text) => ['\x1b[31m', text, RESET].join('');
export const _green = (text) => ['\x1b[32m', text, RESET].join('');
export const _bright = (text) => ['\x1b[1m', text, RESET].join('');
;
