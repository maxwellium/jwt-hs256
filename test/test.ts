...
export async function main() {
  ...
  for (const fixture of FIXTURES.hs256Token) {
    deepStrictEqual(
      generateHS256Token(fixture.o, fixture.k),
      fixture.i,
      `✖ ${ JSON.stringify(fixture.o) } did not yield ${ fixture.i }`
    );
  }
  console.log('✔ passed');
  ...
  for (const fixture of FIXTURES.hs256Token) {
    deepStrictEqual(
      extractHS256Token(fixture.i, fixture.k),
      fixture.o,
      `✖ ${ fixture.i } did not yield ${ fixture.o }`
    );
  }
  console.log('✔ passed');
  ...
  for (const fixture of FIXTURES.base64url) {
    strictEqual(
      base64urlDecode(fixture.o),
      fixture.i,
      `✖ ${ fixture.o } did not yield ${ fixture.i }`
    );
  }
  console.log('✔ passed');
